...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item"><a href="{{ route('purchases.index') }}">Delivery Note</a></li>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="purchase-form" action="{{ route('delivery-notes.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="from-group">
                                        <div class="form-group">
                                            <label for="supplier_id">Consumer <span class="text-danger">*</span></label>
                            ...
                            <livewire:delivery-note-cart :cartInstance="'delivery-note-cart'" />
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary">
                                    Create Delivery Note <i class="bi bi-check"></i>
                                </button>
                            </div>
                        </form>
                    </div>
