            ...
            <table class="table table-bordered">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th class="align-middle text-center">QTY DN</th>
                        <th class="align-middle text-center">QTY Out</th>
                    ...
                    @if ($cart_items->isNotEmpty())
                        @foreach ($cart_items as $cart_item)
                            <tr>
                                ...
                                <td class="align-middle text-center text-center">
                                    <span
                                        class="badge badge-info">{{ $cart_item->options->qty_stockout . ' ' . $cart_item->options->unit }}</span>
                                </td>

                                <td class="align-middle text-center">
                                    @include('livewire.includes.so-cart-quantity')
                                </td>

                                <td class="align-middle text-center">
                                    @include('livewire.includes.so-cart-note')
                                </td>
